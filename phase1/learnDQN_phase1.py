...
num_episodes = 25000        #[25000,100000,500000]        
...
EPS_START = 0.9 # Hyperparameter to be searched
EPS_END = 0.1 # Hyperparameter to be searched
EPS_DECAY_LAST_FRAME = 0.25 * 10**4 # [0.25 * 10**4, 10**4, 2 * 10**4]
TARGET_UPDATE = 1000 # Hyperparameter to be searched
LEARNING_RATE = 1e-4 # [1e-3, 1e-4, 1e-5]
REPLAY_BUFFER_SIZE = 50000 # [5000, 25000, 10000]
Stack_Size = 1 # [1, 4, 10]
...
if __name__ == "__main__":
  ...
  if options.logfile_name == "":
    LOGFILE = "logs/learnDQN_phase1_"+ filename + ".log"
  ...
  # Path of saved model
  PATH = "models/policyDQN_phase1_" + filename + ".pt" 
